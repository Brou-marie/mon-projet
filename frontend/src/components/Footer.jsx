    ...
    <footer className="border-t bg-white">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">AfriStay</h3>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 text-sm text-gray-500">
              <li><a href="/search" className="hover:text-primary-600">Trouver un hébergement</a></li>
              <li><a href="/register" className="hover:text-primary-600">Devenir hébergeur</a></li>
